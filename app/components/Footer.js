      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white px-8 py-3 rounded-md font-medium hover:bg-white hover:text-blue-900 transition-colors">
              Meet Our Leadership Team
            </button>
          </div>
        </div>

        <div className="grid md:grid-cols-4 gap-8 pt-12 border-t border-blue-800">
          <div>
            ...
            <div className="flex space-x-4">
              <Linkedin className="w-5 h-5 text-blue-300 hover:text-white cursor-pointer" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-200">
              <li><a href="#" className="hover:text-white">IT Services</a></li>
              <li><a href="#" className="hover:text-white">Marketing Solutions</a></li>
        ...
        <div className="border-t border-blue-800 mt-8 pt-8 text-center text-blue-300">
          <p>&copy; 2024 Adveb Solutions Inc. All Rights Reserved.</p>
