...
//   return (
//     <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
...
//               <div 
//                 key={index}
//                 className={`relative bg-white rounded-2xl p-8 text-center hover:transform hover:scale-105 transition-all duration-700 hover:shadow-2xl hover:shadow-gray-500/20 animate-fade-in-up border border-gray-200/50 min-h-[420px] flex flex-col justify-between overflow-hidden`}
...
//                   <div className={`absolute top-4 left-4 w-2 h-2 ${service.particleColor} rounded-full animate-pulse opacity-60`}></div>
//                   <div className={`absolute top-12 right-8 w-1 h-1 ${service.particleColor2} rounded-full animate-pulse delay-300 opacity-60`}></div>
//                   <div className={`absolute top-20 left-12 w-3 h-3 ${service.particleColor3} rounded-full animate-pulse delay-700 opacity-40`}></div>
//                   <div className={`absolute bottom-16 right-6 w-2 h-2 ${service.particleColor} rounded-full animate-pulse delay-1000 opacity-60`}></div>
//                   <div className={`absolute bottom-8 left-8 w-1 h-1 ${service.particleColor2} rounded-full animate-pulse delay-500 opacity-60`}></div>
//                   <div className={`absolute top-1/2 right-4 w-2 h-2 ${service.particleColor3} rounded-full animate-pulse delay-1200 opacity-40`}></div>
                  
//                   {/* Floating geometric shapes */}
//                   <div className={`absolute top-8 right-12 w-4 h-4 border border-${service.particleColor.split('-')[1]}-400 rotate-45 animate-spin opacity-30`} style={{animationDuration: '8s'}}></div>
//                   <div className={`absolute bottom-12 left-16 w-3 h-3 border border-${service.particleColor2.split('-')[1]}-400 rounded-full animate-bounce opacity-30`} style={{animationDelay: '2s'}}></div>
//                 </div>
                
//                 <Link href={service.link} className="relative z-10 block">
...
//                   <Link href={service.link} className={`inline-flex items-center justify-center bg-gradient-to-r ${service.buttonGradient} ${service.buttonHover} text-white px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg border-0 font-semibold w-full relative overflow-hidden`}>
