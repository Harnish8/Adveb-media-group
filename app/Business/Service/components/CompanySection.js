  ...
  return (
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Header */}
        <div className="flex flex-col items-center content-center mb-16 animate-fade-in-up">
          <div className="flex items-center mb-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-blue-600 font-semibold mb-2 block">Our quality services</span>
            </div>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 max-w-4xl text-center">
