...
//   return (
//     <div className="relative py-20 lg:py-32 bg-[#020d2f] text-white">
//       <div className="container mx-auto px-4 relative z-10 text-center">
//         <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4">{title}</h1>
//         <ul className="flex justify-center space-x-2 text-gray-300">
//           {paths.map((path, index) => (
//             <li key={index} className="flex items-center">
//               <Link href={path.href} className="hover:text-blue-500 transition-colors">
//                 {path.name}
//               </Link>
...
//           width={100}
//           height={100}
//           className="absolute top-[10%] left-[5%] animate-pulse"
//         />
//         <Image
//           src="/images/3.png"
//           alt="shape"
...
//           width={90}
//           height={90}
//           className="absolute bottom-[15%] right-[25%] animate-pulse"
//         />
//         <Image
//           src="/images/2.png"
//           alt="shape"
//           width={70}
//           height={70}
//           className="absolute top-[5%] right-[20%] animate-pulse"
//         />
//       </div>
//     </div>
//   )
...
export default function PageTitle({ title, paths = [] }) {
  return (
    <div className="relative py-20 lg:py-32 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white overflow-hidden">
      <div className="container mx-auto px-4 relative z-10 text-center">
