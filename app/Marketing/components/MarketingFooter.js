        ...
        <div className="grid md:grid-cols-4 gap-8 pt-12 border-t border-white">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white">
              <li><a href="/Marketing" className="hover:text-white">Home</a></li>
              <li><a href="/Marketing/About" className="hover:text-white">About Us</a></li>
              <li><Link href="/Marketing/Service" className="hover:text-white">Services</Link></li>
              <li><a href="/Marketing/Contact" className="hover:text-white">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white">
              <li><Link href="/Marketing/Service/web-development" className="hover:text-white">Web Development</Link></li>
              <li><Link href="/Marketing/Service/graphic-design" className="hover:text-white">Graphic Design</Link></li>
              <li><Link href="/Marketing/Service/seo" className="hover:text-white">SEO</Link></li>
              <li><Link href="/Marketing/Service/app-development" className="hover:text-white">App Development</Link></li>
            </ul>
          </div>
