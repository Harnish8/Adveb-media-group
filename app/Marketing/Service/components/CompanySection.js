...
import { FileText, Mail, Lightbulb, Share2, Search, TrendingUp } from "lucide-react";
        ...
        <div className="mb-16 animate-fade-in-up">
          <div className="flex items-center mb-6">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-r from-red-400 to-purple-500 rounded-lg flex items-center justify-center">
            ...
            return (
              <div 
                ...
                className={`relative group rounded-3xl p-8 text-left hover:transform hover:scale-105 transition-all duration-500 hover:shadow-2xl animate-fade-in-up min-h-[400px] flex flex-col justify-between overflow-hidden cursor-pointer
                  ${service.isGradient 
                    ? 'bg-gradient-to-br from-red-400 via-purple-500 to-blue-600 text-white' 
                    : 'bg-gray-100 text-gray-900 hover:bg-gradient-to-br hover:from-red-400 hover:via-purple-500 hover:to-blue-600 hover:text-white'}`}
              ...
              >
                ...
                <Link href={service.link} className="relative z-10 block h-full">
                  <div className="flex flex-col h-full">
                    {/* Icon Section */}
                    <div className="mb-8">
                      <div className={`w-20 h-20 rounded-full flex items-center justify-center shadow-lg animate-float hover:scale-110 transition-all duration-300 ${
                        service.isGradient 
                          ? 'bg-white/20 backdrop-blur-sm border border-white/30' 
                          : 'bg-white shadow-md group-hover:bg-white/20 group-hover:backdrop-blur-sm group-hover:border-white/30'
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <p className={`mb-8 leading-relaxed relative flex-1 transition-colors duration-500 ${
                        service.isGradient 
                          ? 'text-white/90' 
                      ...
                      <div className="relative">
                        <div className="inline-flex items-center space-x-3 font-bold text-sm tracking-wider group-hover:translate-x-2 transition-all duration-300">
                          ...
                          <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors duration-500 ${
                            service.isGradient 
                              ? 'bg-white/20' 
                              : 'bg-red-500 group-hover:bg-white/20'
                          }`}>
